...
final class Version20220831192942 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE association (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, name VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, logo LONGTEXT NOT NULL, status VARCHAR(255) DEFAULT NULL, catchphrase LONGTEXT NOT NULL, description LONGTEXT NOT NULL, profile_type LONGTEXT DEFAULT NULL, slug VARCHAR(255) NOT NULL, email LONGTEXT NOT NULL, facebook LONGTEXT DEFAULT NULL, instagram LONGTEXT DEFAULT NULL, twitter LONGTEXT DEFAULT NULL, youtube LONGTEXT DEFAULT NULL, twitch LONGTEXT DEFAULT NULL, discord LONGTEXT DEFAULT NULL, autre LONGTEXT DEFAULT NULL, form LONGTEXT DEFAULT NULL, projects LONGTEXT NOT NULL, thumbnail LONGTEXT DEFAULT NULL, linkedin LONGTEXT DEFAULT NULL, validated TINYINT(1) NOT NULL DEFAULT 0, UNIQUE INDEX UNIQ_FD8521CC5E237E06 (name), INDEX IDX_FD8521CC12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
